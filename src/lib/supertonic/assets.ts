...
/**
 * Einmaliges Aufräumen: Frühere Versionen boten das quantisierte
 * int8-Rechenmodell als Experiment an. Messungen auf echten Geräten
 * zeigten es rund 66 % langsamer als das Original (die quantisierten
 * Operationen fallen auf langsame Ersatzkerne zurück), deshalb ist das
 * Experiment entfernt. Wer es aktiviert hatte, bekommt hier die ~65 MB
 * zurück.
 */
export async function removeInt8Leftovers(): Promise<void> {
  await removeAsset('onnx/vector_estimator_int8.onnx')
}
